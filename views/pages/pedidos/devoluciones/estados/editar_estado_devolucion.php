<?php
session_start();
$pageTitle = "Editar Estado de Devolución";

// TODO: $estado = EstadoDevolucionController::obtenerPorId($_GET['id']);
...
<div class="container-fluid">
    <div class="d-flex justify-content-between mb-4">
        <h2><i class="fas fa-undo-alt text-primary me-2"></i>Editar Estado de Devolución</h2>
