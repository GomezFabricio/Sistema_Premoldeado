<?php
session_start();
$pageTitle = "Editar Estado de Reserva";

// TODO: $estado = EstadoReservaController::obtenerPorId($_GET['id']);
...
<div class="container-fluid">
    <div class="d-flex justify-content-between mb-4">
        <h2><i class="fas fa-calendar-alt text-primary me-2"></i>Editar Estado de Reserva</h2>
