...
<div class="container-fluid">
    <div class="d-flex justify-content-between mb-4">
        <h2><i class="fas fa-receipt text-primary me-2"></i>Crear Venta (Factura)</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="monto_total" name="monto_total" step="0.01" min="0" required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
...
<!-- TODO: Implementar controlador FacturaController::crear() -->
