...
<div class="container-fluid">
    <div class="d-flex justify-content-between mb-4">
        <h2><i class="fas fa-box text-primary me-2"></i>Crear Producto</h2>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="ancho" name="ancho" placeholder="Ej: 40cm" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="largo" class="form-label">Largo</label>
                            <input type="text" class="form-control" id="largo" name="largo" placeholder="Ej: 1.5m" required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="cantidad_disponible" class="form-label">Cantidad Disponible</label>
                            <input type="number" class="form-control" id="cantidad_disponible" name="cantidad_disponible" min="0" value="0" required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
...
<!-- TODO: Implementar controlador ProductoController::crear() -->
