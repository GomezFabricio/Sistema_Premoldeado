...
<div class="container-fluid">
    <div class="d-flex justify-content-between mb-4">
        <h2><i class="fas fa-truck text-primary me-2"></i>Crear Proveedor</h2>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nombres" name="nombres" placeholder="Nombres de la persona" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="apellidos" class="form-label">Apellidos</label>
                            <input type="text" class="form-control" id="apellidos" name="apellidos" placeholder="Apellidos de la persona" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
...
<!-- TODO: Implementar controlador ProveedorController::crear() -->
